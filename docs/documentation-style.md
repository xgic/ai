...
- **Checklist completion before close:** before closing an issue or PR, verify Markdown checklist items (`- [ ]` / `- [x]`), mark completed items, and do not close with unchecked required items unless a human documents a waiver. Also assign before close ([work-tracking-and-checklists.md](work-tracking-and-checklists.md); [AGENTS.md](../AGENTS.md); [BASE-STANDARDS](BASE-STANDARDS-FOR-ORCHESTRATED-REPOS.md))  
