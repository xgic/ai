...
| `cli.wagtail` | Wagtail CLI module | `xgic.cli.wagtail` | `experimental` | [xgic/wagtail-cli](https://github.com/xgic/wagtail-cli) · PyPI [`xgic-wagtail-cli`](https://pypi.org/project/xgic-wagtail-cli/) **0.1.0** | Wagtail product commands (`xgic wagtail …`): `info`, `setup`, `schema`, `dev`; missing ACTION prints full usage; [ADR-0006](../adr/0006-adopt-wagtail.md) |
