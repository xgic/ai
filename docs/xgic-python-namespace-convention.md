...
| Dev Container CLI | CLI module | `xgic.cli.dev` | [xgic/dev-cli](https://github.com/xgic/dev-cli) | 2 | Core CLI | Available — Compose orchestration library (lifecycle subcommands later) |
